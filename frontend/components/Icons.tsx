...
export const LogoIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L3 7V12C3 17.52 6.84 22.74 12 24C17.16 22.74 21 17.52 21 12V7L12 2Z" fill="currentColor" className="text-primary"/>
    <path d="M12 6L5.5 9.5V12.5C5.5 16.5 8.5 20 12 21C15.5 20 18.5 16.5 18.5 12.5V9.5L12 6Z" fill="white" opacity="0.3"/>
    <path d="M10.5 15.5L8 13L9.41 11.59L10.5 12.67L14.59 8.59L16 10L10.5 15.5Z" fill="white"/>
  </svg>
);
